      ...
      {plus ? ( // Apply blur effect only if plus is true or is pressed
        ...
        <>
          <View style={styles.top}>
            <View style={styles.searchBar}>
              <EvilIcons name={'search'} size={20} marginLeft={responsiveWidth(7)} />
              <TextInput
                ref={searchRef}
                placeholder="Search"
                style={{
              ...
              <TouchableOpacity>
                <Ionicons name={'options-outline'} size={30} marginLeft={responsiveWidth(4)} />
              </TouchableOpacity>
            </View>
          </View>
